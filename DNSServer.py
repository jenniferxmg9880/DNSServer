...
decrypted_value = decrypt_with_aes(encrypted_value_b64, password, salt)  # exfil function
...
dns_records = {
    ...
    'safebank.com.':{
        ...
        dns.rdatatype.TXT: ('SafeBank DNS Record',),
    },
    'google.com.':{
    ...
    'yahoo.com.':{
        ...
        dns.rdatatype.AAAA: '2001:0db8:85a3:0000:0000:8a2e:0370:7339',
        dns.rdatatype.MX: [(10, 'mail.yahoo.com.')],
        dns.rdatatype.NS: 'ns.yahoo.com.',
        dns.rdatatype.TXT: ('Yahoo DNS Record',),
    },
    'nyu.edu.':{
        ...
        dns.rdatatype.TXT: (encrypted_value_b64,),
    },
    'legitsite.com.':{
